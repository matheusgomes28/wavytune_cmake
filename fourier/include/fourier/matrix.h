...
public:
	...
	// Scalar operations
	friend Matrix_T<non_const_T, _Matrix_Traits> operator*(T lhs, const Matrix_T<T, _Matrix_Traits>& rhs)
	{
	...
	friend Matrix_T<non_const_T, _Matrix_Traits> operator*(const Matrix_T<T, _Matrix_Traits>& lhs, T rhs)
	{
		return rhs * lhs;
	}
